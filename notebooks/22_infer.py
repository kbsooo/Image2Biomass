...
# # v22 Inference
#
# v22 모델 추론용 (Frozen backbone 학습 모델)
...
class CFG:
    ...
    # ⚠️ 업로드한 v22 모델 경로로 변경
    MODELS_DIR = Path("/kaggle/input/csiro-v22-models")
...
def predict_ensemble(cfg, tta_loaders):
    ...
    for model_file in model_files:
        ...
        model = CSIROModelV22(cfg, cfg.BACKBONE_WEIGHTS).to(cfg.device)
